"""Post Usability testing 2: Exit button (version 1)
Add an exit button at the end window below the play again button.
"""
from tkinter import *
...
def end_quiz():
    ...
    exit_btn = Button(end, text="EXIT", font=(Q_FONT, BTN_SIZE),
                      fg=WHITE, bg=BLACK, width=15, command=end.destroy)

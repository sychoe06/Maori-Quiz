"""Component 6 - End Quiz (version 3) - Trial 2
...
def end_quiz():
    ...
    play_again_btn.pack(ipady=5, pady=10, anchor=CENTER)
    save_results_btn = Button(end, text="SAVE RESULTS", font=(Q_FONT, BTN_SIZE),
                              fg=WHITE, bg=BLACK, width=15)
    save_results_btn.pack(ipady=5, pady=10, anchor=CENTER)

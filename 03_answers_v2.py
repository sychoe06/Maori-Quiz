...
def setup_options(parent, q_num):
    for opts in options_list:
        if opts[0] == q_num:
            ...
            display_options(parent, opt1, 50)  # calls function to display

            opt2 = opts[2]  # Option 2
            display_options(parent, opt2, 350)  # calls function to display

            opt3 = opts[3]  # Option 3
            display_options(parent, opt3, 650)  # calls function to display
